...
receipt = get_operation_receipt_response.receipt
document_str = receipt.document.decode('utf-8') if receipt.document else ""

print(f'Get operation receipt response: {get_operation_receipt_response}')
